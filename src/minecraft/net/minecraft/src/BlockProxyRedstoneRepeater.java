...
public class BlockProxyRedstoneRepeater extends Block {
	...
	protected BlockProxyRedstoneRepeater(int i1, boolean z2) {
	...
	public boolean canPlaceBlockAt(World world1, int i2, int i3, int i4) {
		return !world1.isBlockNormalCube(i2, i3 - 1, i4) && world1.getBlockId(i2, i3 - 1, i4) != mod_DumbStorage.redstoneID ? false : super.canPlaceBlockAt(world1, i2, i3, i4);
	}

	public boolean canBlockStay(World world1, int i2, int i3, int i4) {
		return !world1.isBlockNormalCube(i2, i3 - 1, i4) && world1.getBlockId(i2, i3 - 1, i4) != mod_DumbStorage.redstoneID ? false : super.canBlockStay(world1, i2, i3, i4);
	}
