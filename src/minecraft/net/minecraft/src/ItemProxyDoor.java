...
public class ItemProxyDoor extends Item {
	private Material doorMaterial;

	public ItemProxyDoor(int i1, Material material2) {
		super(i1);
	...
	public boolean onItemUse(ItemStack itemStack1, EntityPlayer entityPlayer2, World world3, int i4, int i5, int i6, int i7) {
		if(i7 != 1) {
			...
			if(!block8.canPlaceBlockAt(world3, i4, i5, i6) && world3.getBlockId(i4, i5 - 1, i6) != mod_DumbStorage.redstoneID) {
				return false;
			} else {
