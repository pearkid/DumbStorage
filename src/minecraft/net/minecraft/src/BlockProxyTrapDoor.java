...
public class BlockProxyTrapDoor extends Block {
	protected BlockProxyTrapDoor(int i1, Material material2) {
		super(i1, material2);
	...
	public void onNeighborBlockChange(World world1, int i2, int i3, int i4, int i5) {
		if(!world1.multiplayerWorld) {
			...
			if(!world1.isBlockNormalCube(i7, i3, i8) && world1.getBlockId(i7, i3, i8) != mod_DumbStorage.redstoneID) {
	...
	public boolean canPlaceBlockOnSide(World world1, int i2, int i3, int i4, int i5) {
		if(i5 == 0) {
			...
			return world1.isBlockNormalCube(i2, i3, i4) || world1.getBlockId(i2, i3, i4) == mod_DumbStorage.redstoneID;
		}
	}
