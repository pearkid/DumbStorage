...
public class BlockProxyDoor extends BlockDoor {
	protected BlockProxyDoor(int i1, Material material2) {
		super(i1, material2);
	...
	public boolean canPlaceBlockAt(World world1, int i2, int i3, int i4) {
		return i3 >= 127 ? false : world1.isBlockNormalCube(i2, i3 - 1, i4) && super.canPlaceBlockAt(world1, i2, i3, i4) && super.canPlaceBlockAt(world1, i2, i3 + 1, i4) || world1.getBlockId(i2, i3 - 1, i4) == mod_DumbStorage.redstoneID && world1.isAirBlock(i2, i3, i4) && world1.isAirBlock(i2, i3 + 1, i4);
	}
