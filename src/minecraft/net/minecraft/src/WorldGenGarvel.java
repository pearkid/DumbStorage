					...
					for(int i39 = i34; i39 <= i35; ++i39) {
						for(int i40 = i36; i40 <= i37; ++i40) {
							...
							if(d41 * d41 + d43 * d43 + d45 * d45 < 1.0D) {
								...
								if(i47 == Block.gravel.blockID) {
									world1.setBlockAndMetadata(i38, i39, i40, this.garvelBlockId, 4);

								}
								if(i47 == Block.sand.blockID) {
									world1.setBlockAndMetadata(i38, i39, i40, this.garvelBlockId, 0);
								}
								if(i47 == Block.dirt.blockID) {
									world1.setBlockAndMetadata(i38, i39, i40, this.dirtsBlockId, 0);
								}
							}
						}
					}
