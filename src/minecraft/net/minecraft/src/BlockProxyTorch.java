...
public class BlockProxyTorch extends Block {
	protected BlockProxyTorch(int i1, int i2) {
	...
	private boolean func_31032_h(World world1, int i2, int i3, int i4) {
		return world1.isBlockNormalCube(i2, i3, i4) || world1.getBlockId(i2, i3, i4) == Block.fence.blockID || world1.getBlockId(i2, i3, i4) == mod_DumbStorage.redstoneID;
	}

	public boolean canPlaceBlockAt(World world1, int i2, int i3, int i4) {
		return world1.isBlockNormalCube(i2 - 1, i3, i4) || world1.getBlockId(i2 - 1, i3, i4) == mod_DumbStorage.redstoneID ? true : (world1.isBlockNormalCube(i2 + 1, i3, i4) || world1.getBlockId(i2 + 1, i3, i4) == mod_DumbStorage.redstoneID ? true : (world1.isBlockNormalCube(i2, i3, i4 - 1) || world1.getBlockId(i2, i3, i4 - 1) == mod_DumbStorage.redstoneID ? true : (world1.isBlockNormalCube(i2, i3, i4 + 1) || world1.getBlockId(i2, i3, i4 + 1) == mod_DumbStorage.redstoneID ? true : this.func_31032_h(world1, i2, i3 - 1, i4))));
	}
	...
	public void onBlockAdded(World world1, int i2, int i3, int i4) {
		...
		if(world1.getBlockId(i2, i3 - 1, i4) != mod_DumbStorage.redstoneID && world1.getBlockId(i2 - 1, i3, i4) != mod_DumbStorage.redstoneID && world1.getBlockId(i2 + 1, i3, i4) != mod_DumbStorage.redstoneID && world1.getBlockId(i2, i3, i4 - 1) != mod_DumbStorage.redstoneID && world1.getBlockId(i2, i3, i4 + 1) != mod_DumbStorage.redstoneID) {
	...
	public void onNeighborBlockChange(World world1, int i2, int i3, int i4, int i5) {
		if(this.dropTorchIfCantStay(world1, i2, i3, i4)) {
			...
			if(!this.func_31032_h(world1, i2, i3 - 1, i4) && i6 == 5 && world1.getBlockId(i2, i3 - 1, i4) != mod_DumbStorage.redstoneID) {
				z7 = true;
			}
	...
	private boolean dropTorchIfCantStay(World world1, int i2, int i3, int i4) {
		if(!this.canPlaceBlockAt(world1, i2, i3, i4) && world1.getBlockId(i2, i3, i4) != mod_DumbStorage.redstoneID) {
			this.dropBlockAsItem(world1, i2, i3, i4, world1.getBlockMetadata(i2, i3, i4));
			world1.setBlockWithNotify(i2, i3, i4, 0);
			return false;
		} else {
